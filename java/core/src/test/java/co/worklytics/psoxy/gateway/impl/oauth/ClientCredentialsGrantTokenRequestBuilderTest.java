...
class ClientCredentialsGrantTokenRequestBuilderTest {
    ...
    @Inject
    ClientCredentialsWithCertificateGrantTokenRequestBuilder payloadBuilder;
    ...
    public void setup() {
        ...
        when(configService.getConfigPropertyAsOptional(ClientCredentialsWithCertificateGrantTokenRequestBuilder.ConfigProperty.TOKEN_SCOPE))
    ...
    public void tokenRequestPayload() {
        when(configService.getConfigPropertyOrError(ClientCredentialsWithCertificateGrantTokenRequestBuilder.ConfigProperty.PRIVATE_KEY))
            .thenReturn(EXAMPLE_PRIVATE_KEY);
        when(configService.getConfigPropertyOrError(ClientCredentialsWithCertificateGrantTokenRequestBuilder.ConfigProperty.PRIVATE_KEY_ID))
