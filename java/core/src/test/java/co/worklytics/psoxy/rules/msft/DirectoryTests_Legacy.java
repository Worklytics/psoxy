...
public class DirectoryTests_Legacy extends JavaRulesTestBaseCase {
    ...
    final RulesTestSpec rulesTestSpec = RulesTestSpec.builder()
        ...
        .exampleSanitizedApiResponsesPath("example-api-responses/sanitized_legacy/")
        .build();
    ...
    @BeforeEach
    void setLegacy() {
        this.sanitizer = sanitizerFactory.create(getRulesUnderTest(),
