...
public class SalesforceTests extends JavaRulesTestBaseCase {
    ...
    public Stream<InvocationExample> getExamples() {
        return Stream.of(
            ...
            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/query?q=SELECT%20Id%2CAnnualRevenue%2CCreatedDate%2CCreatedById%2CIsDeleted%2CLastActivityDate%2CLastModifiedDate%2CLastModifiedById%2CNumberOfEmployees%2COwnerId%2COwnership%2CParentId%2CRating%2CSic%2CType%20FROM%20Account%20WHERE%20LastModifiedDate%3E%3D2016-01-01T00%3A00%3A00Z%20AND%20LastModifiedDate%3C2023-03-01T00%3A00%3A00Z%20ORDER%20BY%20LastModifiedDate%20DESC%20NULLS%20LAST", "accounts_by_query.json"),
            ...
            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/composite/sobjects/Account?ids=0015Y00002c7g95QAA%2C0015Y00002c7g8uQAA&fields=Id%2CAnnualRevenue%2CCreatedDate%2CCreatedById%2CIsDeleted%2CLastActivityDate%2CLastModifiedDate%2CLastModifiedById%2CNumberOfEmployees%2COwnerId%2COwnership%2CParentId%2CRating%2CSic%2CType", "accounts.json"),
            ...
            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/query/SOME_TOKEN", "tasks_by_query.json"),
            ...
            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/query/SOME_TOKEN", "events_by_query.json"),

            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/composite", "composite_accountIds_modified.json"),
            InvocationExample.of("https://test.salesforce.com/services/data/v51.0/composite", "composite_task_and_events.json")
        );
    }
}
