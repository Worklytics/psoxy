...
public class Teams_NoAppIds_Tests extends JavaRulesTestBaseCase {
    ...
    public Stream<InvocationExample> getExamples() {
        ...
        return Stream.of(
                ...
                InvocationExample.of(baseEndpoint + "/teams?$select=id,displayName&$top=50&$skiptoken=abcXYZ123&$filter=startswith(displayName,'C')&$count=true", "Teams_" + "v1.0" + ".json"),
                ...
                InvocationExample.of(baseEndpoint + "/teams/893075dd-2487-4122-925f-022c42e20265/allChannels?$select=id,displayName&$filter=membershipType%20eq%20'standard'", "Teams_allChannels_" + "v1.0" + ".json"),
                ...
                // /users/{id}/chats - allowedQueryParams is "*" (unrestricted); proves an arbitrary/unlisted param is still allowed
                InvocationExample.of(baseEndpoint + "/users/p~JuB1uFI_rtVS0Ygtc3m4uxhEiLI-6vn5ySKma20etlGvAJvlFOlnYuRejZSdIm5tmHzio-TdKzazWRwL50vNeFravJETR0l1WAvE219Jwug/chats?arbitraryTestParam=shouldBeAllowed", "Users_chats_" + "v1.0" + ".json"),
                ...
                InvocationExample.of(baseEndpoint + "/teams/fbe2bf47-16c8-47cf-b4a5-4b9b187c508b/channels/19:4a95f7d8db4c4e7fae857bcebe0623e6@thread.tacv2/messages?$select=id,body&$top=50&$skiptoken=abcXYZ123&$expand=replies", "Teams_channels_messages_" + "v1.0" + ".json"),
                ...
                // /chats/{id}/messages - allowedQueryParams is "*" (unrestricted); proves an arbitrary/unlisted param is still allowed
                InvocationExample.of(baseEndpoint + "/chats/p~bWr_bA0wnI4CDi2z8MuXG2vEmijbgJ9-MX1hsrnF20ik1FwGIGIQ_uMj2B_4LQV7U7F8XPs4Nx_URHgdx-pukZu2Hb6QzmB24IBvBInSdwA/messages?arbitraryTestParam=shouldBeAllowed", "Chats_messages_" + "v1.0" + ".json"),
                ...
                InvocationExample.of(baseEndpoint + "/communications/callRecords/getPstnCalls(fromDateTime=2019-11-01,toDateTime=2019-12-01)?$skip=10", "Communications_callRecords_getPstnCalls_" + "v1.0" + ".json"),
                // /users/{id} - with all allowed query params
                InvocationExample.of(baseEndpoint + "/users/p~JuB1uFI_rtVS0Ygtc3m4uxhEiLI-6vn5ySKma20etlGvAJvlFOlnYuRejZSdIm5tmHzio-TdKzazWRwL50vNeFravJETR0l1WAvE219Jwug?$select=id,mail", "user.json"),
                ...
                // /users/{id}/onlineMeetings - allowedQueryParams is "*" (unrestricted); proves an arbitrary/unlisted param is still allowed
                InvocationExample.of(baseEndpoint + "/users/p~JuB1uFI_rtVS0Ygtc3m4uxhEiLI-6vn5ySKma20etlGvAJvlFOlnYuRejZSdIm5tmHzio-TdKzazWRwL50vNeFravJETR0l1WAvE219Jwug/onlineMeetings?arbitraryTestParam=shouldBeAllowed", "Users_onlineMeetings_" + "v1.0" + ".json"),
                ...
                // /onlineMeetings/{id}/attendanceReports - allowedQueryParams is "*" (unrestricted); proves an arbitrary/unlisted param is still allowed
                InvocationExample.of(baseEndpoint + "/users/p~JuB1uFI_rtVS0Ygtc3m4uxhEiLI-6vn5ySKma20etlGvAJvlFOlnYuRejZSdIm5tmHzio-TdKzazWRwL50vNeFravJETR0l1WAvE219Jwug/onlineMeetings/MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ/attendanceReports?arbitraryTestParam=shouldBeAllowed", "Users_onlineMeetings_attendanceReports_" + "v1.0" + ".json"),
                ...
                // /onlineMeetings/{id}/attendanceReports/{id} - allowedQueryParams is "*" (unrestricted); proves an arbitrary/unlisted param is still allowed
                InvocationExample.of(baseEndpoint + "/users/p~JuB1uFI_rtVS0Ygtc3m4uxhEiLI-6vn5ySKma20etlGvAJvlFOlnYuRejZSdIm5tmHzio-TdKzazWRwL50vNeFravJETR0l1WAvE219Jwug/onlineMeetings/MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ/attendanceReports/c9b6db1c-d5eb-427d-a5c0-20088d9b22d7?arbitraryTestParam=shouldBeAllowed", "Users_onlineMeetings_attendanceReport_" + "v1.0" + ".json")
        );
    }
}
