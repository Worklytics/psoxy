...
class RESTApiSanitizerImplTest {
    ...
    @Singleton
    @Component(
            modules = {PsoxyModule.class, ForConfigService.class, MockModules.ForSecretStore.class,
    ...
    void redactRegexMatches(String source) {
        ...
        String redacted = (String) sanitizer.sanitizerUtils.getRedactRegexMatches(transform)
    ...
    void redactExceptPhases(String raw, String sanitized) {
        ...
        String redacted = (String) sanitizer.sanitizerUtils.getRedactExceptPhrases(transform)
                .map(raw, sanitizer.jsonConfiguration);
    ...
    void pseudonymizeWithReversalKey() {
        ...
        MapFunction f = sanitizer.sanitizerUtils.getPseudonymize(sanitizer.getPseudonymizer(),
    ...
    void textDigest(String input, int expectedWordCount, int expectedLength) {
        ...
        String resultJson =
                (String) textDigestFunction.map(input, sanitizer.getJsonConfiguration());
    ...
    void pseudonymize_multivalueEmailHeaders(String headerValue) {
        ...
        MapFunction mapFunction =
                sanitizer.getPseudonymizeEmailHeaderToJson(Transform.PseudonymizeEmailHeader
                        .builder().encoding(PseudonymEncoder.Implementations.JSON).build());

        String asJson = (String) mapFunction.map(headerValue, sanitizer.getJsonConfiguration());

        List<PseudonymizedIdentity> pseudonyms = sanitizer.sanitizerUtils
                .pseudonymizeEmailHeader(sanitizer.getPseudonymizer(), headerValue);
