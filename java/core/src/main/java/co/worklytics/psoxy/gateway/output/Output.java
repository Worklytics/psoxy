...
public interface Output {
     ...
     * @throws WriteFailure if an error occurs while writing the content
     */
    void write(ProcessedContent content) throws WriteFailure;
     ...
     * @throws WriteFailure if an error occurs while writing the content
     */
    void write(String key, ProcessedContent content) throws WriteFailure;


     class WriteFailure extends IOException {
        public WriteFailure(String message, Throwable cause) {
            super(message, cause);
        }
