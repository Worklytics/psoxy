...
public class PrebuiltSanitizerRules {
    ...
    static final RESTRules GITHUB = Rules2.builder()
            ...
            .endpoint(ORG_MEMBERS.withPathTemplate("/api/v3/orgs/{org}/members"))
            .endpoint(USERS)
            .endpoint(USERS.withPathTemplate("/api/v3/users/{username}"))
            .endpoint(GRAPHQL_FOR_USERS)
            .endpoint(GRAPHQL_FOR_USERS.withPathTemplate("/api/graphql"))
            .endpoint(ORG_TEAMS)
            .endpoint(ORG_TEAMS.withPathTemplate("/api/v3/orgs/{org}/teams"))
            .endpoint(ORG_TEAM_MEMBERS)
            .endpoint(ORG_TEAM_MEMBERS.withPathTemplate("/api/v3/orgs/{org}/teams/{teamSlug}/members"))
            .endpoint(ORG_AUDIT_LOG)
            .endpoint(ORG_AUDIT_LOG.withPathTemplate("/api/v3/orgs/{org}/audit-log"))
            .endpoint(ORG_AUDIT_LOG_WITH_INSTALLATION_ID)
            .endpoint(ORG_AUDIT_LOG_WITH_INSTALLATION_ID.withPathTemplate("/api/v3/organizations/{installationId}/audit-log"))
            .endpoint(REPOSITORIES)
            .endpoint(REPOSITORIES.withPathTemplate("/api/v3/orgs/{org}/repos"))
            .endpoint(REPO_BRANCHES)
            .endpoint(REPO_BRANCHES.withPathTemplate("/api/v3/repos/{owner}/{repo}/branches"))
            .endpoint(REPO_COMMITS)
            .endpoint(REPO_COMMITS.withPathTemplate("/api/v3/repos/{owner}/{repo}/commits"))
            .endpoint(REPO_COMMIT)
            .endpoint(REPO_COMMIT.withPathTemplate("/api/v3/repos/{owner}/{repo}/commits/{ref}"))
            .endpoint(REPO_EVENTS)
            .endpoint(REPO_EVENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/events"))
            .endpoint(COMMIT_COMMENTS)
            .endpoint(COMMIT_COMMENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/commits/{commitSha}/comments"))
            .endpoint(COMMIT_COMMENT_REACTIONS)
            .endpoint(COMMIT_COMMENT_REACTIONS.withPathTemplate("/api/v3/repos/{owner}/{repo}/comments/{commentId}/reactions"))
            .endpoint(ISSUE)
            .endpoint(ISSUE.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/{issueNumber}"))
            .endpoint(ISSUES)
            .endpoint(ISSUES.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues"))
            .endpoint(ISSUE_COMMENTS)
            .endpoint(ISSUE_COMMENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/{issueNumber}/comments"))
            .endpoint(ISSUE_EVENTS)
            .endpoint(ISSUE_EVENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/{issueNumber}/events"))
            .endpoint(ISSUE_TIMELINE)
            .endpoint(ISSUE_TIMELINE.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/{issueNumber}/timeline"))
            .endpoint(ISSUE_REACTIONS)
            .endpoint(ISSUE_REACTIONS.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/{issueNumber}/reactions"))
            .endpoint(ISSUE_COMMENT_REACTIONS)
            .endpoint(ISSUE_COMMENT_REACTIONS.withPathTemplate("/api/v3/repos/{owner}/{repo}/issues/comments/{commentId}/reactions"))
            .endpoint(PULL_REVIEWS)
            .endpoint(PULL_REVIEWS.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls/{pullNumber}/reviews"))
            .endpoint(PULLS)
            .endpoint(PULLS.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls"))
            .endpoint(PULL_COMMENTS)
            .endpoint(PULL_COMMENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls/{pullNumber}/comments"))
            .endpoint(PULL_REVIEW_COMMENTS)
            .endpoint(PULL_REVIEW_COMMENTS.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls/{pullNumber}/reviews/{reviewId}/comments"))
            .endpoint(PULL_COMMITS)
            .endpoint(PULL_COMMITS.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls/{pullNumber}/commits"))
            .endpoint(PULL)
            .endpoint(PULL.withPathTemplate("/api/v3/repos/{owner}/{repo}/pulls/{pullNumber}"))
            .build();
