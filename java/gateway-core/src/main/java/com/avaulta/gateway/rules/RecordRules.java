...
public class RecordRules implements BulkDataRules {
     ...
     * Never {@code null} after construction or {@link #setAugments}; omitted YAML is an empty list.
     *
    ...
    /**
     * Jackson may pass {@code null} when the property is omitted or explicit null; stored as empty
     * list so callers never see a null {@link #augments} field (same contract as {@link #setTransforms}).
     */
