...
class Rules1UtilsTest {
    ...
    public interface Container {
        void inject( Rules1UtilsTest test);
    }
    ...
    void getRulesFromFileSystem() {
        ...
        Optional<Rules1> rules = utils.getRulesFromFileSystem(path);
    ...
    void getRulesFromConfig() {
        ...
        Rules1 rules = utils.getRulesFromConfig(config).get();
        assertNotNull(rules);
    }
}
