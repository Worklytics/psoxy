...
| Mail                                                                                                   | [data](docs/sources/microsoft-365/outlook-mail/example-api-responses) - [rules](docs/sources/microsoft-365/outlook-mail/outlook-mail.yaml) | `User.Read.All` `Group.Read.All`  `Mail.ReadBasic.All` `MailboxSettings.Read`                                                                               |
 | Teams **beta**                                                                                        | [data](docs/sources/microsoft-365/-msft-teams/example-api-responses) - [rules](docs/sources/microsoft-365/msft-teams/teams.yaml)           | `Team.ReadBasic.All` `Channel.ReadBasic.All` `Chat.ReadBasic.All` `Chat.Read.All` `ChannelMessage.Read.All` `CallRecords.Read.All` `OnlineMeetings.Read.All` |
