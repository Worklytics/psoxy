...
Google Workspace always requires Google Directory data to be connected:

| Required Source&nbsp; | Examples&nbsp;&nbsp;&nbsp;&nbsp;                                                                                                          | Scopes Needed                                                                                            |
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
Additionally, you may connect any of the supported Google Workspace sources include:
