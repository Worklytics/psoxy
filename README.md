...
| Github                    | [docs/sources/github](docs/sources/github.md)                               | **Read Only** permissions for: <br/>Repository: Contents, Issues, Metadata, Pull requests<br/>Organization: Administration, Members           |
