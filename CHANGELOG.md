...
## [0.6.0](https://github.com/Worklytics/psoxy/release/tag/v0.6.0)
...
- `Atlassian Organization API`: added new connector for fetching audit events from Atlassian Organization API, which provides access to audit events from users and toos like Rovo.
