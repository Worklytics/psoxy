...
- `gcp`: **beta** customer guide for the external Application Load Balancer, including the required Cloud Run custom-audience step, and `tools/gcp/configure-custom-audiences.sh` to register those audiences after apply. See [docs/gcp/guides/external-alb.md](docs/gcp/guides/external-alb.md).
