...
|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Google Calendar                | [data](sources/google-workspace/calendar/example-api-responses) - [rules](sources/google-workspace/calendar/calendar.yaml)      | `calendar.readonly`                                                                                                                                                                                       |
| Google Chat                    | [data](sources/google-workspace/google-chat/example-api-responses) - [rules](sources/google-workspace/google-chat/google-chat.yaml) | `admin.reports.audit.readonly`                                                                                                                                                                            |
| Google Directory               | [data](sources/google-workspace/directory/example-api-responses) - [rules](sources/google-workspace/directory/directory.yaml)   | `admin.directory.user.readonly admin.directory.user.alias.readonly admin.directory.domain.readonly admin.directory.group.readonly admin.directory.group.member.readonly admin.directory.orgunit.readonly` |
| Google Drive                   | [data](sources/google-workspace/gdrive/example-api-responses) - [rules](sources/google-workspace/gdrive/gdrive.yaml)            | `drive.metadata.readonly`                                                                                                                                                                                 |
| GMail                          | [data](sources/google-workspace/gmail/example-api-responses) - [rules](sources/google-workspace/gmail/gmail.yaml)               | `gmail.metadata`                                                                                                                                                                                          |
| Google Meet                    | [data](sources/google-workspace/meet/example-api-responses) - [rules](sources/google-workspace/meet/meet.yaml)                  | `admin.reports.audit.readonly`                                                                                                                                                                            |
...
See details: [sources/google-workspace/readme.md](sources/google-workspace/google-workspace.md)
...
|--------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| Active Directory                                                                                       | [data](sources/microsoft-365/directory/example-api-responses) - [rules](sources/microsoft-365/directory/directory.yaml)          | `User.Read.All` `Group.Read.All`                                                                                                                  |
| Calendar                                                                                               | [data](sources/microsoft-365/outlook-cal/example-api-responses) - [rules](sources/microsoft-365/outlook-cal/outlook-cal.yaml)    | `User.Read.All` `Group.Read.All` `OnlineMeetings.Read.All` `Calendars.Read` `MailboxSettings.Read`                                                |
| Mail                                                                                                   | [data](sources/microsoft-365/outlook-mail/example-api-responses) - [rules](sources/microsoft-365/outlook-mail/outlook-mail.yaml) | `User.Read.All` `Group.Read.All`  `Mail.ReadBasic.All` `MailboxSettings.Read`                                                                     |
| Teams (**__beta__**)                                                                                   | [data](sources/microsoft-365/msft-teams/example-api-responses) - [rules](sources/microsoft-365/msft-teams/msft-teams.yaml)| `User.Read.All` `Team.ReadBasic.All` `Channel.ReadBasic.All` `Chat.Read.All` `ChannelMessage.Read.All` `CallRecords.Read.All` `OnlineMeetings.Read.All`  |
...
| if connecting to Google Workspace | [Google Cloud CLI](https://cloud.google.com/sdk/docs/install)                              | 1.0+    | `gcloud version` | <ul><li>[Service Account Creator](https://cloud.google.com/iam/docs/understanding-roles#iam.serviceAccountCreator)</li><li>[Service Account Key Admin](https://cloud.google.com/iam/docs/understanding-roles#iam.serviceAccountKeyAdmin)</li><li>[Service Usage Admin](https://cloud.google.com/iam/docs/understanding-roles#serviceusage.serviceUsageAdmin)</li></ul><br/>see [sources/google-workspace/google-workspace.md](sources/google-workspace/google-workspace.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
