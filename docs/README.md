...
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| GitHub Copilot (**__beta__**) | [data](https://github.com/Worklytics/psoxy/tree/main/docs/sources/github/copilot/example-api-responses) - [rules](https://github.com/Worklytics/psoxy/tree/main/docs/sources/github/copilot/github-copilot.yaml)                               | Organization: `Administration`, `Members`, `GitHub Copilot Business`                                |
