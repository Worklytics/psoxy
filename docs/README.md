...
For all of these, a Google Workspace Admin must authorize the Google OAuth client you provision (with [provided terraform modules](https://github.com/Worklytics/psoxy/tree/main/infra/examples)) to access your organization's data. This requires a Domain-wide Delegation grant with a set of scopes specific to each data source, via the Google Workspace Admin Console.
...
| Gemini Bulk (**deprecated**)                                                                                                          | [data](https://github.com/Worklytics/psoxy/tree/main/docs/sources/google-workspace/gemini-usage/example.csv)                                                                                                                                                             | n/a;  bulk export of Gemini logs |
