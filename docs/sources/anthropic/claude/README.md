...
| `GET /v1/compliance/apps/sessions/local/{localSessionId}/messages` | Individual messages within a local session (message text is hashed) | `read:compliance_user_data` |
...
| `GET /v1/compliance/apps/sessions/remote/{claudeRemoteSessionId}/messages` | Individual messages within a remote session (message text is hashed) | `read:compliance_user_data` |
