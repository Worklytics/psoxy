...
The full set of supported keys is documented on the `msft_365_connector_settings` variable itself (`infra/modules/worklytics-connector-specs/variables.tf`); see [Microsoft OneDrive](msft-onedrive/README.md#populating-example-api-calls-with-real-ids) for a worked example of populating a connector's group/drive/item ids this way.
