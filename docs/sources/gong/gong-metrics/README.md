...
- [Example Rules](gong-metrics.yaml)
- Example Data:
  ...
  - [original/activity_aggregate.json](example-api-responses/original/activity_aggregate.json) | [sanitized/activity_aggregate.json](example-api-responses/sanitized/activity_aggregate.json)
