...
- fixed IPS for your outbound API requests to data sources. This requires [configuring VPC and some additional features](./guides/vpc.md). This is beyond scope of Worklytics support, but our provided terraform configurations and proxy code are compatible with using such features.