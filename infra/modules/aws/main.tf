...
locals {
  ...
  conditional_statements_for_caller_role_assumption =
    concat(local.aws_caller_statements, local.gcp_service_account_caller_statements)
}
...
resource "aws_iam_role" "api-caller" {
  ...
  assume_role_policy = jsonencode({
    ...
    "Statement" : concat([
      ...
      local.conditional_statements_for_caller_role_assumption)
  })
}
