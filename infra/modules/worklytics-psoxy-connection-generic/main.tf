...
locals {
  ...
  deep_link_last_step           = 3 + (length(local.per_setting_instructions) > 0 ? 1 : 0)
  last_step                     = 5 + (length(local.per_setting_instructions) > 0 ? 1 : 0) + 1
...
EOT
  ...
  ${local.deep_link_last_step}. Review any additional settings that connector supports, adjusting values as you see fit, then
     click "Connect".
