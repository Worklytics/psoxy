...
**Beta.** Provisions a global external Application Load Balancer (ALB), with optional Cloud Armor, in front of GCP API connector Cloud Run / Cloud Functions services.
