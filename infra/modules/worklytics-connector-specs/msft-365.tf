  ...
  msft_365_connectors = {
    ...
    "outlook-cal" : {
      ...
      example_api_calls : [
        ...
        "/v1.0/users/${var.example_msft_user_guid}/calendarView?startDateTime=${timeadd(var.example_api_calls_month_start, "-4320h")}&endDateTime=${var.example_api_calls_month_start}",
    ...
    "msft-teams" : {
      ...
      example_api_calls : [
        ...
        "/v1.0/communications/callRecords/getDirectRoutingCalls(fromDateTime=${urlencode(timeadd(var.example_api_calls_month_start, "-2160h"))},toDateTime=${urlencode(var.example_api_calls_month_start)})",
        "/v1.0/communications/callRecords/getPstnCalls(fromDateTime=${urlencode(timeadd(var.example_api_calls_month_start, "-2160h"))},toDateTime=${urlencode(var.example_api_calls_month_start)})",
