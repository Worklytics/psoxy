...
variable "jira_cloud_id" {
  type        = string
  default     = null
  description = "[DEPRECATED - use connector_settings map instead] (Only required if using Jira Cloud connector) Example of cloud id of the Jira Cloud to connect to (ex: 1324a887-45db-1bf4-1e99-ef0ff456d421)."
}
...
variable "example_jira_issue_id" {
  type        = string
  default     = null
  description = "[DEPRECATED - use connector_settings map instead] Deprecated; use `jira_example_issued_id`. (Only required if using Jira Server/Cloud connector) Id of an issue for only to be used as part of example calls for Jira (ex: ETV-12)"
}
...
variable "salesforce_example_account_id" {
  type        = string
  default     = null
  description = "[DEPRECATED - use connector_settings map instead] (Only required if using Salesforce connector) Id of the account id for using as an example calls for Salesforce (ex: 0015Y00002c7g95QAA)"
}
