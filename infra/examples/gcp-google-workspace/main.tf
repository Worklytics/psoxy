...
module "psoxy-gcp" {
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp?ref=v0.3.0-beta.6"
...
module "google-workspace-connection-auth" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-sa-auth-key-secret-manager?ref=v0.3.0-beta.6"
...
module "psoxy-google-workspace-connector" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-psoxy-cloud-function?ref=v0.3.0-beta.6"
...
module "worklytics-psoxy-connection" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-psoxy-connection?ref=v0.3.0-beta.6"
