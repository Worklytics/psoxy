...
module "psoxy-gcp" {
  # source = "../../modules/gcp"
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp?ref=v0.4.5-jrc"
...
module "google-workspace-connection" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/google-workspace-dwd-connection?ref=v0.4.5-jrc"
...
module "google-workspace-connection-auth" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-sa-auth-key-secret-manager?ref=v0.4.5-jrc"
...
module "psoxy-google-workspace-connector" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-psoxy-rest?ref=v0.4.5-jrc"
...
module "worklytics-psoxy-connection" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-psoxy-connection?ref=v0.4.5-jrc"
...
module "connector-long-auth-block" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-oauth-long-access-strategy?ref=v0.4.5-jrc"
...
module "psoxy-gcp-bulk" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-psoxy-bulk?ref=v0.4.5-jrc"
