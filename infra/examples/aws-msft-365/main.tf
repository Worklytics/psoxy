...
module "worklytics_connector_specs" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-connector-specs?ref=v0.4.5-jrc"
...
module "psoxy-aws" {
  # source = "../../modules/aws"
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws?ref=v0.4.5-jrc"
...
module "msft-connection" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-connection?ref=v0.4.5-jrc"
...
module "msft-connection-auth" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-local-cert?ref=v0.4.5-jrc"
...
module "private-key-aws-parameters" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/private-key-aws-parameter?ref=v0.4.5-jrc"
...
module "psoxy-msft-connector" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-psoxy-rest?ref=v0.4.5-jrc"
...
module "msft_365_grants" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-grant-all-users?ref=v0.4.5-jrc"
...
module "worklytics-psoxy-connection-msft-365" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-psoxy-connection-aws?ref=v0.4.5-jrc"
