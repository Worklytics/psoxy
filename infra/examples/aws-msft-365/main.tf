...
module "psoxy-aws-msft-365" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modular-examples/aws-msft-365?ref=v0.4.12"
...
output "todos_1" {
  ...
  value = module.psoxy-aws-msft-365.todos_1
}

output "todos_2" {
  description = "List of todo steps to complete 2nd, in markdown format."
  value = module.psoxy-aws-msft-365.todos_2
}

output "todos_3" {
  description = "List of todo steps to complete 3rd, in markdown format."
  value = module.psoxy-aws-msft-365.todos_3
}
