...
module "psoxy-gcp" {
  source = "../../modules/gcp"
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp?ref=rc-v0.4.61"
...
module "google-workspace-key-secrets" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-secrets?ref=rc-v0.4.61"
...
module "psoxy-google-workspace-connector" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-psoxy-rest?ref=rc-v0.4.61"
...
module "connector-oauth" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-oauth-secrets?ref=rc-v0.4.61"
...
module "long-auth-token-secret-fill-instructions" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-secret-fill-md?ref=rc-v0.4.61"
...
module "psoxy-gcp-bulk" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/gcp-psoxy-bulk?ref=rc-v0.4.61"
