...
module "worklytics_connectors_google_workspace" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-connectors-google-workspace?ref=rc-v0.5.10"
  ...
  tf_gcp_principal_email         = var.google_workspace_terraform_sa_account_email
