...
variable "llm_budget" {
  ...
  description = "Optional Vertex genMetadata Cloud Billing budget settings. When null, no budget is created. When set, billing_account_id is required. Monthly budget is sized as daily × 30."
  default     = null
  nullable    = true
