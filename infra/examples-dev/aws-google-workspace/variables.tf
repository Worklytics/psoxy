...
variable "caller_aws_arns" {
  ...
  validation {
    ...
    error_message = "The values of caller_aws_arns should be AWS Resource Names, something like 'arn:aws:iam::123123123123:root', 'arn:aws:iam::123123123123:user/ExampleUser', 'arn:aws:iam:123123123123:role/TestRole'"qq # for testing; can remove once prod-ready
  }
}
