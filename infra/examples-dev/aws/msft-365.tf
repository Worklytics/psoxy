...
module "worklytics_connectors_msft_365" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-connectors-msft-365?ref=rc-v0.5.19"
...
module "cognito_identity_pool" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-pool?ref=rc-v0.5.19"
...
module "cognito_identity" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-identity-cli?ref=rc-v0.5.19"
...
module "msft_connection_auth_federation" {
  ...
  # source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-federated-credentials?ref=rc-v0.5.19"
